...
public class PaarResultBuilder implements Function<Collection<BlastMatch>, PaarResult> {

  private final Logger logger = LoggerFactory.getLogger(PaarResultBuilder.class);
  private final PaarLibrary paarLibrary;

  public PaarResultBuilder(final PaarLibrary paarLibrary) {
