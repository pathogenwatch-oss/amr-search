...
public class ResistanceSet {
  ...
  private final Set<AntimicrobialAgent> agents;
  ...
  public ResistanceSet(final String resistanceSetName, final String elementId, final ResistanceType effect, final ResistanceGene.EFFECT elementEffect, final Set<AntimicrobialAgent> agents, final String phenotype) {
  ...
  public Set<AntimicrobialAgent> getAgents() {
